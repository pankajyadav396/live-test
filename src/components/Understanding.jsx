        ...
        <>
            <div className="py-5">
                <div className=" container-lg max-w-container pt-5 mt-1">
                    <h1 className=" color-blue fs-lg ff-sans text-capitalize fw-bold text-center lh-57 mb-md-4 mb-3">Understanding leveraged <span className="d-block"> accounts and <span className=" color-skyblue">buying power</span> </span></h1>
                    ...
                    <div className="row align-items-center justify-content-center">
                        {Understandingarr.map((e, index) => {
                            return (
                                <div className={`${index == 2 ? "mt-4 mt-lg-0" : index == 1 ? "mt-4 mt-md-0" : ''} col_xlg_4 col-md-6 col-sm-8`}>
                                    <div className="box-understd position-relative  z-1 overflow-hidden d-flex flex-column h-100 ">
                                        <div className=' img-box1 mx-auto d-flex align-items-center justify-content-center'>
                                            <img src={e.img} alt="img" className=' mx-auto blurimg' />
                                        ...
                                        <p className='text-center ff-inter color-grey fw-normal fs-sm lh-25 pt-3 text-balance'>{e.description}</p>
                                        <span className='z-n1 position-absolute ellipse1'> </span>
                                    </div>
                                </div>
                            )
                        })}
