import imgbulb from '../../assets/images/svg/bulbsvg.svg'
import imgenergy from '../../assets/images/svg/energy.svg'
import imgtrans from '../../assets/images/svg/transfer.svg'

export const Understandingarr = [
    {
        img: imgbulb,
...
export const Somesteps = [
    {
        SrNO: '1',
        title: 'Sign Up',
        description: 'Fill in the module',
        btnText: "Register now"
    },
    {
        SrNO: '2',
        title: 'Verification',
        description: 'Completw The Verification of your account with ours authorized representative',
        btnText: "Book a call"
    ...
    },
    {
        SrNO: '3',
        title: 'Investing',
        description: 'Start investing on your financial future',
